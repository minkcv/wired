...
function loadLevel6() {
    ...
    // Visuals
    TH.addSpinningCylinderPart(499, 10, 0, 149, 75, 0.01);
    TH.addSpinningCylinderPart(499, 10, 0, 141, 75, 0.01);
    ...
    addSpinningObject(499, 10, 0, models.spinroom, 0.01, 0.15, 0, 'y', Math.PI / 2);
    addSpinningObject(499, 10, 0, models.spinroomthreshhold, 0.01, 0.15, 0, 'y', Math.PI / 2);
    addSpinningObject(499, 10, 0, models.spinroom, 0.01, 0.14, 0, 'y', Math.PI / 2);
    ...
    */
    ...
    MA.addFromPoints(499, -20, revolvingWall);

    MA.addWall({x: -50, y: -60}, {x: 359, y: -60}); // Left wall near
    MA.addWall({x: -50, y: 60}, {x: 359, y: 60}); // Right wall near
    MA.addWall({x: -50, y: -60}, {x: -50, y: 60}); // Back wall
